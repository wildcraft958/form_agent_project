...
class FormProcessor:
    ...
    def process_form(self):
        ...
        for field_name, field_data in self.form_data.items():
            ...
            while attempts < self.max_attempts:
                ...
                field_prompt = self._create_descriptive_field_prompt(field_name, field_data)
                ...
                is_valid, validation_message, processed_value = self._validate_input(field_name, field_data, user_input)
    ...
    def _create_system_prompt(self):
        ...
        form_description = "You are filling out a medical prescription form. "
        ...
        form_description += "\nPlease provide accurate medical information for the prescription."
